...
<body>
	<div class="loginbox">
		<div class="outer">
			<div class="outer-1">
				<img src="assets/img/admin.png" class="logo" />
			</div>
		</div>
		<div class="title">Admin Login</div>

		<form method="POST" action="assets/php/login.php" autocomplete="off">
			<?php if (isset($_GET['error'])) { ?>
				<div class="error-text alert"><?php echo $_GET['error']; ?></div>
			<?php } ?>
			<?php if (isset($_GET['success'])) { ?>
				<div class="success-text alert"><?php echo $_GET['success']; ?></div>
			<?php } ?>
			<div class="form">
				<div class="username">
				...
				<div class="password">
					<input type="password" class="input2" id="password-field" name="pass" placeholder="password" minlength="5" required />

					<svg class="passicon" viewBox="0 0 64 64">
						<path d="M26,46V38a3,3,0,0,0-6,0v8a5,5,0,0,0,1.81,8.84A5.37,5.37,0,0,0,23,55a5,5,0,0,0,3-9Zm-1.14,6.33a3,3,0,1,1-3.36-4.93,1,1,0,0,0,.5-.87V38a1,1,0,0,1,2,0v8.55a1,1,0,0,0,.5.87,3,3,0,0,1,.36,4.93Z" />
						...
						<path d="M54.89,40.45l-1.78-.9-.68,1.35A7.09,7.09,0,1,0,54,42.16ZM54,47a5.05,5.05,0,1,1-2.47-4.29l-2.7,5.4-2-2.71-1.6,1.2,3,4a1,1,0,0,0,.8.4h.09a1,1,0,0,0,.8-.55l3.17-6.34A4.92,4.92,0,0,1,54,47Z" />
					</svg>
					<span><i id="toggler" class="far fa-eye toggle-password"></i></span>
				</div>
			</div>
